...
function App() {
  ...
  */
  ...
  console.log(arr1);//arr1에 4가 같이 추가(같이 추가됐다기 보단느 하나를 공유했기 때문에 발생한 결과)
  console.log('-------------------')
  ...
  /*appleCount라는 변수에 arr5에 1이 저장되고,
  //bananaCount 변수에 arr5에 있는 2가 저장되고,
  orangeCount 변수에 arr5에 있는 3가 저장되도록 작성
