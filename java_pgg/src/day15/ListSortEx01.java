...
public class ListSortEx01 {
	...
	public static void main(String[] args) {
		 ...
		 * - Comparator 객체 : Compartor 인터페이스를 구현한 구현 클래스의 객체가 필요
		 * 		그런데 아래 코드에서 String 클래스는 라이브러리에서 제공한는 클래스이기 때문에 우리가 수정할 수 없다.
		...
		stds.add(new Student("2024160002", "또치"));
		stds.add(new Student("2024135001", "마이콜"));
		stds.add(new Student("2024160004", "고길동"));
		stds.add(new Student("2024133001", "둘리"));
