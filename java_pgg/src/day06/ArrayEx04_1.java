...
public class ArrayEx04_1 {
	...
	public static void main(String[] args) {
		//4자리 정수를 입력받아 입력받은정수를 정수를 역순으로 배열에 저장하고 출력하는 코드를 작성
		//1234 => 0번지에 4,1번지에 3 ,2번지에2, 3번지에 1을 저장하고 4,3,2,1순으로 출력
		...
		//123=> 3을 추출해서 배열에 저장하고 , 123=>12로만듬
		//12 => 2를 추출해서 배열에 저장하고 , 12 => 1로만듬
