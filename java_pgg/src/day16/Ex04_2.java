...
public class Ex04_2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("국어 평균 : " + sumEng / (double) list.size());
		int sumMath = sumMath(list);
		System.out.println("국어 평균 : " + sumMath / (double) list.size());
	...
	private static void printEng(List<Student> list) {
		for (Student tmp : list) {
			System.out.println("이름 : " + tmp.getName() + "국어 : " + tmp.getEng());
		}
